...
const FRUIT_SCENES = [
	preload("res://Suika/Scenes/fruit1.tscn"), # 40%
	preload("res://Suika/Scenes/fruit2.tscn"), # 30%
	preload("res://Suika/Scenes/fruit3.tscn"), # 20%
	preload("res://Suika/Scenes/fruit4.tscn"), # 10%
	preload("res://Suika/Scenes/fruit5.tscn")  # 5%
]
