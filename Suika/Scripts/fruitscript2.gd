...
func _ready():
	...
	if fruit_scenes.is_empty():
		...
		fruit_scenes = [
			preload("res://Suika/Scenes/fruit1.tscn"),
			preload("res://Suika/Scenes/fruit2.tscn"),
			preload("res://Suika/Scenes/fruit3.tscn"),
			preload("res://Suika/Scenes/fruit4.tscn"),
			preload("res://Suika/Scenes/fruit5.tscn")
		]
